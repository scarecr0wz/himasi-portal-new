        ...
        <footer id="footer" className="bg-white border-t border-slate-200 py-16">
            <div className="w-full max-w-[1440px] mx-auto px-5 md:px-10 lg:px-14 xl:px-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    <div className="flex flex-col gap-6">
                        <div className="flex items-center gap-2">
                            <img src="/logo-himasi.png" alt="HIMA SI" className="h-8 w-auto object-contain" />
                        </div>
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <p className="text-sm text-slate-500">Berlangganan untuk info terbaru dari HIMA SI.</p>
                ...
                <div className="pt-8 border-t border-slate-100 flex flex-col md:flex-row items-center justify-between gap-4">
                    <p className="text-slate-400 text-[10px] font-medium tracking-wide">© {new Date().getFullYear()} HIMA SI Universitas Terbuka Bogor. Dikelola oleh Departemen Media & Publikasi.</p>
